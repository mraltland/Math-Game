...
public class GameSubtraction extends AppCompatActivity {
    ...
    long time_lift_in_milis = START_TIMER_IN_MILIS;
    ...
    {
        timer = new CountDownTimer(time_lift_in_milis,1000) {
            @Override
            public void onTick(long millisUntilFinished) {

                time_lift_in_milis = millisUntilFinished;
                updateText();
    ...
    {
        int second = (int) (time_lift_in_milis / 1000) % 60;
    ...
    public void resetTimer()
    {
        ...
        time_lift_in_milis = START_TIMER_IN_MILIS;
        updateText();
